...
-- The results show that Legobricks produced the most revenue, but due to its cost it does not have the highest total profits. Colorbuds has the highest total profits
...
-- this next query looks at the costs based on the categories of the products. 
  select 
  year,  
  SUM(
